...
namespace Contellation.Custom.Events.Control.Dragablz
{
    ...
    public class ItemActionCallbackArgs<TOwner> where TOwner : FrameworkElement
    {
        ...
        public ItemActionCallbackArgs(System.Windows.Window window, TOwner owner, DragablzItem dragablzItem)
        {
