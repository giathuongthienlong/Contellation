...
using Contellation.Custom.Interactivities.Layouts;
...
namespace Contellation.Custom.Controls.Windows.Dialogs
{
    ...
    public class Dialog : ContentControl
    {
        ...
        public static readonly DependencyProperty IsClosedProperty = DependencyProperty.Register(
            nameof(IsClosed), typeof(bool), typeof(Dialog), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty MaskCanCloseProperty = DependencyProperty.RegisterAttached(
            "MaskCanClose", typeof(bool), typeof(Dialog), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.Inherits));
