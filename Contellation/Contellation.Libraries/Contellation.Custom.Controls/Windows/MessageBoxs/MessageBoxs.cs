...
namespace Contellation.Custom.Controls
{
    ...
    public class MessageBox : Window
    {
        ...
        public static readonly DependencyProperty PrimaryButtonAppearanceProperty = DependencyProperty.Register(nameof(PrimaryButtonAppearance),
            typeof(ControlAppearance), typeof(MessageBox), new PropertyMetadata(ControlAppearance.Primary));
        ...
        public static readonly DependencyProperty SecondaryButtonAppearanceProperty = DependencyProperty.Register(nameof(SecondaryButtonAppearance),
            typeof(ControlAppearance), typeof(MessageBox), new PropertyMetadata(ControlAppearance.Secondary));
        ...
        public static readonly DependencyProperty CloseButtonAppearanceProperty = DependencyProperty.Register(nameof(CloseButtonAppearance),
            typeof(ControlAppearance), typeof(MessageBox), new PropertyMetadata(ControlAppearance.Secondary));
        ...
        public static readonly DependencyProperty IsPrimaryButtonEnabledProperty = DependencyProperty.Register(nameof(IsPrimaryButtonEnabled),
            typeof(bool), typeof(MessageBox), new PropertyMetadata(true));
        ...
        public static readonly DependencyProperty IsSecondaryButtonEnabledProperty = DependencyProperty.Register(nameof(IsSecondaryButtonEnabled),
            typeof(bool), typeof(MessageBox), new PropertyMetadata(true));
        ...
        {
            Topmost = true;
            SetValue(TemplateButtonCommandProperty, new RelayCommand<Enums.Control.MessageBoxButton>(OnButtonClick));
        ...
        protected TaskCompletionSource<Enums.Control.MessageBoxResult>? Tcs { get; set; }
        ...
        public async Task<Enums.Control.MessageBoxResult> ShowDialogAsync(bool showAsDialog = true, CancellationToken cancellationToken = default)
        {
            Tcs = new TaskCompletionSource<Enums.Control.MessageBoxResult>();
        ...
        protected override void OnClosing(CancelEventArgs e)
        {
            ...
            _ = Tcs?.TrySetResult(Enums.Control.MessageBoxResult.None);
        }
        ...
        protected virtual void OnButtonClick(Enums.Control.MessageBoxButton button)
        {
            Enums.Control.MessageBoxResult result = button switch
            {
                Enums.Control.MessageBoxButton.Primary => Enums.Control.MessageBoxResult.Primary,
                Enums.Control.MessageBoxButton.Secondary => Enums.Control.MessageBoxResult.Secondary,
                _ => Enums.Control.MessageBoxResult.None
            };
