...
namespace Contellation.Custom.Controls.Datas.DataGrids.Generic
{
    public class Loc
    {
        private TranslateLanguage language = TranslateLanguage.English;
        ...
        public TranslateLanguage Language
        {
            ...
            set
            {
                ...
                var propertyInfo =
                    type.GetProperty(
                        Enum.GetName(typeof(TranslateLanguage), language) ??
                        throw new ArgumentException("Language is required", nameof(TranslateLanguage)),
