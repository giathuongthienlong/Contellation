...
namespace Contellation.Custom.Controls
{
    public class DataGridBoundColumn : System.Windows.Controls.DataGridBoundColumn, IDataGridColumn
    {
        ...
        /// <summary> FieldName Dependency Property. </summary>
        public static readonly DependencyProperty FieldNameProperty = DependencyProperty.Register(nameof(FieldName),
            typeof(string), typeof(DataGridBoundColumn), new PropertyMetadata(""));

        public bool IsColumnFiltered
        {
            get { return (bool)GetValue(IsColumnFilteredProperty); }
            set { SetValue(IsColumnFilteredProperty, value); }
        }
        /// <summary> IsColumnFiltered Dependency Property. </summary>
        public static readonly DependencyProperty IsColumnFilteredProperty = DependencyProperty.Register(nameof(IsColumnFiltered),
            typeof(bool), typeof(DataGridBoundColumn), new PropertyMetadata(false));
    ...
    public class DataGridCheckBoxColumn : System.Windows.Controls.DataGridCheckBoxColumn, IDataGridColumn
    {
        ...
        /// <summary> FieldName Dependency Property. </summary>
        public static readonly DependencyProperty FieldNameProperty = DependencyProperty.Register(nameof(FieldName),
            typeof(string), typeof(DataGridCheckBoxColumn), new PropertyMetadata(""));
        ...
        /// <summary> IsColumnFiltered Dependency Property. </summary>
        public static readonly DependencyProperty IsColumnFilteredProperty = DependencyProperty.Register(nameof(IsColumnFiltered),
            typeof(bool), typeof(DataGridCheckBoxColumn), new PropertyMetadata(false));
    }
    ...
    public class DataGridComboBoxColumn : System.Windows.Controls.DataGridComboBoxColumn, IDataGridColumn
    {
        ...
        /// <summary> FieldName Dependency Property. </summary>
        public static readonly DependencyProperty FieldNameProperty = DependencyProperty.Register(nameof(FieldName),
            typeof(string), typeof(DataGridComboBoxColumn), new PropertyMetadata(""));
        ...
        /// <summary> IsColumnFiltered Dependency Property. </summary>
        public static readonly DependencyProperty IsColumnFilteredProperty = DependencyProperty.Register(nameof(IsColumnFiltered),
            typeof(bool), typeof(DataGridComboBoxColumn), new PropertyMetadata(false));
    ...
    public class DataGridNumericColumn : DataGridTextColumn
    {
        ...
        public void BuildRegex()
        {
            ...
            switch (Type.GetTypeCode(fieldType))
            {
                ...
                case TypeCode.Single:
                    var decimalSeparator = stringFormat.Contains("c") ? Regex.Escape(nfi.CurrencyDecimalSeparator) : Regex.Escape(nfi.NumberDecimalSeparator);
        ...
        protected override bool CommitCellEdit(FrameworkElement editingElement)
        {
            ...
            {
                if (string.IsNullOrEmpty(tb.Text)) { tb.Text = originalValue; }
            }
        ...
        protected override object PrepareCellForEdit(FrameworkElement editingElement, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (fieldType == null)
                {
                    var filterDataGrid = (DataGrid)DataGridOwner;
                    ...
                    stringFormat = string.IsNullOrEmpty(((Binding)Binding).StringFormat) ? string.Empty : ((Binding)Binding).StringFormat.ToLower();
        ...
        private void OnPaste(object sender, DataObjectPastingEventArgs e)
        {
            ...
            if (e.SourceDataObject.GetData(DataFormats.Text) is string pasteText && sender is TextBox textBox)
            {
                ...
                if (!regex.IsMatch(newText)) { e.CancelCommand(); }
            }
        }
    ...
    public class DataGridTemplateColumn : System.Windows.Controls.DataGridTemplateColumn, IDataGridColumn
    {
        ...
        /// <summary> FieldName Dependency Property. </summary>
        public static readonly DependencyProperty FieldNameProperty = DependencyProperty.Register(nameof(FieldName),
            typeof(string), typeof(DataGridTemplateColumn), new PropertyMetadata(""));
        ...
        /// <summary> IsColumnFiltered Dependency Property. </summary>
        public static readonly DependencyProperty IsColumnFilteredProperty = DependencyProperty.Register(nameof(IsColumnFiltered),
            typeof(bool), typeof(DataGridTemplateColumn), new PropertyMetadata(false));
    }
    ...
    public class DataGridTextColumn : System.Windows.Controls.DataGridTextColumn, IDataGridColumn
    {
        ...
        /// <summary> FieldName Dependency Property. </summary>
        public static readonly DependencyProperty FieldNameProperty = DependencyProperty.Register(nameof(FieldName),
            typeof(string), typeof(DataGridTextColumn), new PropertyMetadata(""));
        ...
        /// <summary> IsColumnFiltered Dependency Property. </summary>
        public static readonly DependencyProperty IsColumnFilteredProperty = DependencyProperty.Register(nameof(IsColumnFiltered),
            typeof(bool), typeof(DataGridTextColumn), new PropertyMetadata(false));
    }
}
