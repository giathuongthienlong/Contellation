...
using Contellation.Custom.Enums.Control.DataGrid;
...
namespace Contellation.Custom.Controls
{
    ...
    public class DataGrid : System.Windows.Controls.DataGrid, INotifyPropertyChanged
    {
        #region Constructors
        ...
        public DataGrid()
        {
            Debug.WriteLineIf(DebugMode, "DataGrid.Constructor");
        ...
        /// <summary>
        /// Identifies the <see cref="CheckBoxColumnElementStyle"/> dependency property.
        /// </summary>
        ...
        /// <summary>
        /// Identifies the <see cref="CheckBoxColumnEditingElementStyle"/> dependency property.
        /// </summary>
        ...
        /// </summary>
        public static readonly DependencyProperty ExcludeFieldsProperty = DependencyProperty.Register(nameof(ExcludeFields),
            typeof(string), typeof(DataGrid), new PropertyMetadata(""));
        ...
        {
            get { return (string)GetValue(ExcludeColumnsProperty); }
            set { SetValue(ExcludeColumnsProperty, value); }
        }
        /// <summary>
        ///     Excluded Column (only AutoGeneratingColumn)
        /// </summary>
        public static readonly DependencyProperty ExcludeColumnsProperty = DependencyProperty.Register(nameof(ExcludeColumns),
            typeof(string), typeof(DataGrid), new PropertyMetadata(""));
        ...
        ///     Date format displayed
        /// </summary>
        public static readonly DependencyProperty DateFormatStringProperty = DependencyProperty.Register(nameof(DateFormatString),
            typeof(string), typeof(DataGrid), new PropertyMetadata("d"));

        /// <summary>
        ///     Language
        /// </summary>
        public TranslateLanguage FilterLanguage
        {
            get { return (TranslateLanguage)GetValue(FilterLanguageProperty); }
            set { SetValue(FilterLanguageProperty, value); }
        }
        /// <summary>
        ///     Language displayed
        /// </summary>
        public static readonly DependencyProperty FilterLanguageProperty = DependencyProperty.Register(nameof(FilterLanguage),
            typeof(TranslateLanguage), typeof(DataGrid), new PropertyMetadata(TranslateLanguage.English));
        ...
        ///     Show elapsed time in status bar
        /// </summary>
        public static readonly DependencyProperty ShowElapsedTimeProperty = DependencyProperty.Register(nameof(ShowElapsedTime),
            typeof(bool), typeof(DataGrid), new PropertyMetadata(false));
        ...
        ///     Show status bar
        /// </summary>
        public static readonly DependencyProperty ShowStatusBarProperty = DependencyProperty.Register(nameof(ShowStatusBar),
            typeof(bool), typeof(DataGrid), new PropertyMetadata(false));
        ...
        ///     Show Rows Count
        /// </summary>
        public static readonly DependencyProperty ShowRowsCountProperty = DependencyProperty.Register(nameof(ShowRowsCount),
            typeof(bool), typeof(DataGrid), new PropertyMetadata(false));
        ...
        {
            get { return (bool)GetValue(PersistentFilterProperty); }
            set { SetValue(PersistentFilterProperty, value); }
        }
        /// <summary>
        ///     Persistent filter
        /// </summary>
        public static readonly DependencyProperty PersistentFilterProperty = DependencyProperty.Register(nameof(PersistentFilter),
            typeof(bool), typeof(DataGrid), new PropertyMetadata(false));
        ...
        {
            get { return (Brush)GetValue(FilterPopupBackgroundProperty); }
        ...
        /// </summary>
        public static readonly DependencyProperty FilterPopupBackgroundProperty = DependencyProperty.Register(nameof(FilterPopupBackground),
            typeof(Brush), typeof(DataGrid), new PropertyMetadata(null));
        ...
        public bool StartsWith
        {
            ...
            set
            {
                startsWith = value; OnPropertyChanged();
        ...
        {
            get { return treeView ?? new List<FilterItemDate>(); }
            set { treeView = value; OnPropertyChanged(); }
        }
        ...
        {
            get { return listBoxItems ?? new List<FilterItem>(); }
            set { listBoxItems = value; OnPropertyChanged(); }
        }
        ...
        public Type FieldType
        {
            ...
            set { fieldType = value; OnPropertyChanged(); }
        }
        ...
        /// <param name="e"></param>
        private void OnLoadFilterDataGrid(DataGrid filterDataGrid, DependencyPropertyChangedEventArgs e)
        {
            ...
            FilterPopupBackground = FilterPopupBackground == null && hostingWindow != null ? hostingWindow.Background : new SolidColorBrush(Colors.White);

            if (filterDataGrid.PersistentFilter) { filterDataGrid.LoadPreset(); }
        }
        ...
        private void GeneratingCustomsColumn()
        {
            ...
            try
            {
                ...
                foreach (var dataGridColumn in Columns)
                {
                    ...
                    var col = dataGridColumn as IDataGridColumn;

                    if (col == null || !col.IsColumnFiltered)
                        continue;
                    ...
                    if (dataGridColumn.HeaderTemplate != null)
                    {
                        ...
                        // reset filter Button
                        var buttonFilter = VisualTreeHelpers.GetHeader(dataGridColumn, this)
                            ?.FindVisualChild<Button>("FilterButton");
                    ...
                    else
                    {
                        ...
                        // Convert to switch, only one case should ever get used, so checking for each type should be uneessary.
                        ...
                        switch (col)
                        {
                            ...
                            case DataGridTextColumn textColumn:
                                ...
                                fieldProperty = CollectionType.GetProperty(((Binding)textColumn.Binding).Path.Path);
                                ...
                                {
                                    if (string.IsNullOrEmpty(textColumn.Binding.StringFormat)) textColumn.Binding.StringFormat = DateFormatString;
                                }
                            ...
                            case DataGridComboBoxColumn comboBoxColumn:
                                ...
                                var binding = (Binding)comboBoxColumn.SelectedValueBinding ??
        ...
        private async void ApplyFilterCommand(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            {
                /* 
                 * Tài nguyên miễn phí (việc hủy đăng ký sự kiện và kích hoạt lại "columnHeadersPresenter" được thực hiện trong phương thức PopupClosed) 
                 */
        ...
        private void PopupPlacement(FrameworkElement grid, FrameworkElement header)
        {
            try
            {
                ...
                if (popup.HorizontalOffset == 0) { grid.MaxWidth = MaxSize(Math.Abs(grid.MaxWidth - offset)); }
