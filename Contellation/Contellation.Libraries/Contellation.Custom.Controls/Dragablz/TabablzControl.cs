...
using Contellation.Custom.Controls.Dragablz.Dockablz;
using Contellation.Custom.Controls.Dragablz.Referenceless;
...
namespace Contellation.Custom.Controls
{
    ...
    public class TabablzControl : TabControl
    {
        ...
        internal static void SetIsClosingAsPartOfDragOperation(System.Windows.Window element, bool value)
        {
            element.SetValue(IsClosingAsPartOfDragOperationProperty, value);
        }

        /// <summary>
        /// Helper method which can tell you if a <see cref="System.Windows.Window"/> is being automatically closed due
        /// to a user instigated drag operation (typically when a single tab is dropped into another window.
        /// </summary>
        /// <param name="element"></param>
        /// <returns></returns>
        public static bool GetIsClosingAsPartOfDragOperation(System.Windows.Window element)
        {
        ...
        private Point ConfigureNewHostSizeAndGetDragStartWindowOffset(System.Windows.Window currentWindow, INewTabHost<System.Windows.Window> newTabHost, DragablzItem dragablzItem, bool isTransposing)
        {
