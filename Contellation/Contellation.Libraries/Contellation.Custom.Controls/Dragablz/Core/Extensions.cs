...
namespace Contellation.Custom.Controls.Dragablz.Core
{
    internal static class Extensions
    {
        ...
        /// <returns></returns>
        public static double GetActualLeft(this System.Windows.Window window)
        {
            if (window.WindowState == WindowState.Maximized)
            {
                var leftField = typeof(System.Windows.Window).GetField("_actualLeft", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        ...
        /// <param name="window"></param>
        /// <returns></returns>
        public static double GetActualTop(this System.Windows.Window window)
        {
            if (window.WindowState == WindowState.Maximized)
            {
                var topField = typeof(System.Windows.Window).GetField("_actualTop", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
